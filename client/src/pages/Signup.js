  ...
  return (
    <section className='bg-gray-50'>
      <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
        <main className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <div className="card text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">
              <h4 className="card-header text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">Create an Account</h4>
              <div className="card-body">
                ...
                {error && (
                  <div className="my-3 p-3 bg-danger text-black text-center">
                    {error.message}
                  </div>
                )}
              </div>
